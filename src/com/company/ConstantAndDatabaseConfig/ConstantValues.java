...
public class ConstantValues {
    ...
    public static String SEASON_COLUMN = "season", WINNER_COLUMN = "winner", BOWLING_TEAM = "bowling_team", BOWLER = "bowler", MATCH_PLAYED = "match_played", TOTAL_WINS = "total_wins", EXTRA_RUNS = "extra_runs", MATCH_WIN = "match_win", ECONOMICAL_RATE = "economical_rate";
